        ...
        <div class="widget widget-chart-one">
            ...
            <div class="widget-content">
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-3 align-self d-flex justify-content-around">
                        @if ($userid > 0 && $fromDate !=null && $toDate !=null)
                        <button wire:click.prevent="Consultar" class="btn btn-dark" type="button">Consultar</button>
                        @endif
                        @if ($total > 0 )
                        <button wire:click.prevent="Print()" class="btn btn-dark" type="button">Imprimir</button>
                        @endif
                    </div>
                        ...
                        <table class="table table-bordered table-striped mt-1">
                            <thead class="text-white" style="background: #3B3F5c">
                                <tr>
                                    ...
                                    <th class="table-th text-center text-white">HORA</th>
                            ...
                            <tbody>
                                ...
                                <td class="text-center"><h6>{{ $row->created_at->format('Y-M-d') }}</h6></td>
                                <td class="text-center"><h6>{{ $row->created_at->isoFormat('HH:mm:ss A') }}</h6></td>
