...
class UsersController extends Component
{
    ...
    public function Store()
    {
        ...
        $messages = [
            ...
            'name.min' => 'Nombre del usuario debe tener al menos 3 caracteres',
            'email.required' => 'El correo es requerido',
            'email.email' => 'Ingresa un correo valido',
            'email.unique' => 'El email ya existe en sistema',
            'status.required' => 'El estatus es requerido',
            'status.not_in' => 'Selecciona un status distinto a Elegir',
            ...
            'password.min' => 'Es password debe contener al menos 8 caracteres'
        ];
    ...
    public function destroy(User $user)
    {
        if($user) {
            ...
            if($sales > 0) {
                $this->emit('user-withsales', 'No es posible eliminar usuario porque tienes ventas registradas');
            } else {
                $user->delete();
                $this->resetUI();
