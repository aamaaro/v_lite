        ...
        <table cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <td colspan="2" class="text-center">
                    <span style="font-size: 25px; font-weight: bold">Click Now Solutions</span>
                </td>
            </tr>
            <tr>
                <td width="30%" style="vertical-align: top; padding-top: 2px; position: relative;">
                    <img src="{{ asset('vendor/adminlte/dist/img/logo1.jpg') }}"  class="invoice-logo">
                </td>
